...
try
{
    ...
    Console.WriteLine("داخل وضع المراجعة: الأسهم الرئيسية أو أسهم لوحة الأرقام مع NumLock مغلق للحرف والسطر وCtrl+الأسهم للكلمة والفقرة وHome/End لبداية ونهاية السطر.");
